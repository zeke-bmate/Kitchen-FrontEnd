import { Dialog, DialogTitle, DialogContent, Typography, Paper, Table, TableBody, TableCell, TableContainer, TableHead, TableRow, IconButton, Box, Stack } from "@mui/material";
                    ...
                    <TableBody>
                        { selectedRecipe.ingredients.map((i) => (
                            <TableRow key={i.id} >
                                ...
                                <TableCell align="center" >{i.quantity} {formatUnit(i.rawIngredient.canonicalUnit)}</TableCell>
                            </TableRow>
                            ))
                        }
                    </TableBody>
